  ...
  return (
    <div className="space-y-4">
      {comments.map((comment) => (
        <div key={comment.id} className="flex space-x-3 p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-2 mb-1">
              ...
              <span className="text-xs text-slate-500">{formatTimeAgo(comment.time)}</span>
            </div>
